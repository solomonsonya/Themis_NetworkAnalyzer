 ...
 * 
 * Received information is put here for retrieval. Once found, it will be broadcasted back to the connected agents.  
 * 
...
public class ResolutionRequest_ServerSocket extends Thread implements Runnable
{
	public static final String myClassName = "ResolutionRequest_ServerSocket";
	public volatile static Driver driver = new Driver();

	public static volatile LinkedList<ResolutionRequest_ServerSocket> list_server_sockets = new LinkedList<ResolutionRequest_ServerSocket>();
	...
	public volatile LinkedList<ResolutionRequest_ThdSocket> list_connections = new LinkedList<ResolutionRequest_ThdSocket>();
	
	
	
	public ResolutionRequest_ServerSocket(int preferred_port)
	{
		try
		{
			PORT = preferred_port;
	...
	public void run()
	{
		...
		{
			//start serversocket
			driver.directive("Attempting to establish request resolution server socket on port [" + PORT + "]");
			...
			while(continue_run)
			{
				...
				ResolutionRequest_ThdSocket thd = new ResolutionRequest_ThdSocket(this, skt);
			}
