/**
 * Retrieve Whois resolution information along with IDS alert info
 * 
...
public class Whois_IDS_ResolutionRequest_ThdSocket extends Thread implements Runnable
{
	public static final String myClassName = "Whois_IDS_ResolutionRequest_ThdSocket";
	public volatile Driver driver = new Driver();

	public Whois_IDS_ResolutionRequest_ServerSocket parent = null;
	...
	public static volatile LinkedList<Whois_IDS_ResolutionRequest_ThdSocket> list_outbound_connections = new LinkedList<Whois_IDS_ResolutionRequest_ThdSocket>();
	
	/**iterate through this list to send all collected sensor data across*/
	public static volatile LinkedList<Whois_IDS_ResolutionRequest_ThdSocket> ALL_CONNECTIONS = new LinkedList<Whois_IDS_ResolutionRequest_ThdSocket>();
	...
	public Whois_IDS_ResolutionRequest_ThdSocket(Whois_IDS_ResolutionRequest_ServerSocket par, Socket skt)
	{
		try
		{
			parent = par;
	...
	public Whois_IDS_ResolutionRequest_ThdSocket(String address)
	{
		try
		{
	...
	public Whois_IDS_ResolutionRequest_ThdSocket(String addr, String PORT)
	{
		try
		{
	...
	public boolean set_connection_address()
	{
		try
		{
			...
			Parser.GLOBAL_EXCALIBUR_IDS_CONNECTION_ADDRESS = distant_end_ip;
			Parser.GLOBAL_EXCALIBUR_IDS_CONNECTION_PORT = distant_end_port;
	...
	public boolean process_line(String line)
	{
		try
		{
			...
			//Let the Whois deal with the received line
			Whois whois = new Whois(line);
		...
		catch(Exception e)
		{
			...
			sop("Line received to process: -->" + line);
		}
	...
	public boolean sop(String out)
	{
		try
		{
			driver.sop("[" + this.myClassName + " - " + this.getId() + "] --> " + out);
