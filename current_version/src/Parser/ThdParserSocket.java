/**
 * Socket class - Purpose of this class is to connect out to or receive a connection from a Themis Sensor. 
 * Once a connection is established, any line received across the socket is passed into one of the Parser threads
 * to process the line and incorporate into the User Interface 
 * 
