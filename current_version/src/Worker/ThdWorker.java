...
//			
	...
	public boolean processInterrupt_60_SEC()
	{
		try
		{
			...
			//RESET QUERY LIMITS
			//
			GEO_Location.IP_API_QUERY_COUNT = 0;
	...
	public boolean update_jtable_protocol()
	{
		try
		{
			...
			if(StandardInListener.intrface.jtblApplicationCategorization_out.jcbRejectUpdate.isSelected())
				return false;
	...
	public boolean update_jtable_resolution()
	{
		try
		{
			...
			if(StandardInListener.intrface.jtblResolution.jcbRejectUpdate.isSelected())
				return false;
