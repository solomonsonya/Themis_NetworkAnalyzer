...
public class Node_GeoIP 
{
	...
	public static volatile boolean jitter_lat_lon = true;
	public static double jitter_lat_value = 0;
	public static double jitter_lon_value = 0;
	...
	public volatile String value_graph = null;
	...
	public volatile double lat = 0, lon = 0;
	...
	public String getMapDetails()
	{
		...
		{						
			...
			value = value
					...
					+ "<br><b>country name: </b>"  + country_name 
					+ "<br><b>region code: </b>"  + region_state_code 
					+ "<br><b>region name: </b>"  + region_state_name 
					+ "<br><b>city: </b>"  + city 
					+ "<br><b>zip code: </b>"  + zip_code 
					+ "<br><b>time zone: </b>"  + time_zone 
					+ "<br><b>latitude: </b>" + latitude 
					+ "<br><b>longitude: </b>" + longitude 
					+ "<br><b>metro code: </b>" + metro_area_code; 
		...
		{
			driver.eop(myClassName, "getMapDetails", e);
		}
	...
	/**
	 * ok for pivot to be null. Then pivot = source. Do this in case we want to project a central node that the others will link off from the pivot
	 * e.g. if source == google.com, you could have pivot == REGISTRAR, and then all other nodes could link off of the pivot to appear better in the map
	 * @param source
	 * @param pivot
	 * @return
	 */
	public String get_graph_links(String source, String pivot)
	{
		try
		{
			value_graph = "";
			
			if(pivot == null || pivot.trim().equals(""))
			{
				pivot = source;
			}
			else
			{
				value_graph = "{source: \"" + source + "\", target:  \"" + pivot + "\", type: \"solid\"}, ";
			}
			
			if(ip != null && !ip.trim().equals(""))
				value_graph = value_graph + "{source: \"" + pivot + "\", target:  \"IP:   " + ip + "\", type: \"solid_aquamarine\"}, " ;
				
			if(country_code != null && !country_code.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"country_code:   " + country_code + "\", type: \"solid_aquamarine\"}, " ;
			 	
			if(country_name != null && !country_name.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"country_name:   " + country_name + "\", type: \"solid_aquamarine\"}, " ;
				
			if(region_state_code != null && !region_state_code.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"region_state_code:   " + region_state_code + "\", type: \"solid_aquamarine\"}, " ;
				
			if(region_state_name != null && !region_state_name.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"region_state_name:   " + region_state_name + "\", type: \"solid_aquamarine\"}, " ;
				
			if(city != null && !city.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"city:   " + city + "\", type: \"solid_aquamarine\"}, " ;
			 	
			if(zip_code != null && !zip_code.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"zip_code:   " + zip_code + "\", type: \"solid_aquamarine\"}, " ;
				
			if(time_zone != null && !time_zone.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"time_zone:   " + time_zone + "\", type: \"solid_aquamarine\"}, " ;
				
			if(latitude != null && !latitude.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"latitude:   " + latitude + "\", type: \"solid_aquamarine\"}, " ;
				
			if(longitude != null && !longitude.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"longitude:   " + longitude + "\", type: \"solid_aquamarine\"}, " ;
			 	
			if(metro_area_code != null && !metro_area_code.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"metro_area_code:   " + metro_area_code + "\", type: \"solid_aquamarine\"}, " ;
		...
		{
			driver.eop(myClassName, "get_graph_links", e);
		}
		
		return "";
	}
	
	public double get_latitude(boolean return_double_value)
	{
		try
		{
			if(return_double_value)
				return lat;
	...
	public double get_longitude(boolean return_double_value)
	{
		try
		{
			if(return_double_value)
