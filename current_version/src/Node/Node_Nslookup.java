	...
	public String get_graph_links(String source, String pivot)
	{
		try
		{
			...
			if(server != null && !server.trim().equals(""))
				value_graph = value_graph + "{source: \"" + pivot + "\", target:  \"Server:   " + server + "\", type: \"solid_deeppink\"}, " ;
				
			/*if(address_1 != null && !address_1.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"address_1:   " + address_1 + "\", type: \"solid_deeppink\"}, " ;*/
			 	
			if(name != null && !name.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"name:   " + name + "\", type: \"solid_deeppink\"}, " ;
				
			/*if(address_2 != null && !address_2.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"address_2:   " + address_2 + "\", type: \"solid_deeppink\"}, " ;*/
				
			/*if(value != null && !value.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"value:   " + value + "\", type: \"solid_deeppink\"}, " ;*/
				
			if(ipv4_first != null && !ipv4_first.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"ipv4:   " + ipv4_first + "\", type: \"solid_deeppink\"}, " ;
			 	
			/*if(ipv4 != null && !ipv4.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"ipv4:   " + ipv4 + "\", type: \"solid_deeppink\"}, " ;
				
			if(ipv6 != null && !ipv6.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"ipv6:   " + ipv6 + "\", type: \"solid_deeppink\"}, " ;*/
				
			if(ipv6_first != null && !ipv6_first.trim().equals(""))
				value_graph = value_graph +  "{source: \"" + pivot + "\", target:  \"ipv6:   " + ipv6_first + "\", type: \"solid_deeppink\"}, " ;
