...
import Typed_URL.Typed_URL_Extractor;
	...
	public class Driver 
	{
		...
		public static final String NAME = "Themis NetAnalyzer";
		public static final String NAME_LOWERCASE = NAME.toLowerCase();
		public static final String VERSION = "1.041a";
		...
		//CUT
		//
		public static Typed_URL_Extractor url_extractor = new Typed_URL_Extractor(300000);
		//public static File_Orbiter file_orbiter = new File_Orbiter(1000);
		
		
		//start the parser to read in the file
		public static OUI_Parser oui_parser = null;//new OUI_Parser(OUI_Parser.OUI_PATH, true);

		
		public static final String NOT_FOUND = "no results returned from selected query";
		public static final String NO_RESULTS = NOT_FOUND;
		...
		public static volatile Node_Process PROCESS_DAEMON = new Node_Process(3000);
		public static volatile Node_Netstat NETSTAT_DAEMON = new Node_Netstat(1000);
		
		public static volatile String default_dns_server_address = "";				
		public static volatile String my_external_ip_address = "";
			...
			{	
				if(output_enabled)	
				{
					...
					if(StandardInListener.intrface != null)
						StandardInListener.intrface.jpnlConsole.append(out);
				}				
			} 
			catch(Exception e){}
		...
		public void sp(String out)	
		{
			...
			{	
				if(output_enabled)	
				{
					...
					if(StandardInListener.intrface != null)
						StandardInListener.intrface.jpnlConsole.append_sp(out);
				}
			}
			catch(Exception e){}
			...
			try
			{
				...
				while((line = br.readLine()) != null)
				{
					...
					{						
						...
						//directive("INTERFACE NUMBER: " + interface_number + " INTERFACE NAME: " + interface_name + "\n\n\n");
						...
						//populate in list
						//
						//if(!tshark_interfaces.contains(full_designation))
						//	tshark_interfaces.add(full_designation);
						
						if(!tshark_interfaces.contains(interface_name))
							tshark_interfaces.add(interface_name);
