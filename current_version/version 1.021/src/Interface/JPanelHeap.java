...
public class JPanelHeap extends JPanel implements Runnable, ActionListener
{
	...
	public static volatile JCheckBox jcbGEO_ResolutionEnabled = new JCheckBox("GEO", true);
	...
	public void actionPerformed(ActionEvent ae)
	{
		try
		{
			...
			{
				GEO_Location.AUTOMATIC_GEO_RESOLUTION_ENABLED = this.jcbGEO_ResolutionEnabled.isEnabled();
