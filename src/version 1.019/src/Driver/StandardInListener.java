...
import Parser.*;
import Profile.Cookie_Container_Host_System;
import Profile.Cookie_Object_Host_System;
...
public class StandardInListener extends Thread implements Runnable
{
	...
	public static volatile boolean launch_configuration_BOTH_SENSOR_AND_PARSER = true;
	public static volatile boolean launch_configuration_PARSER = true;
	public static volatile boolean launch_configuration_SENSOR = true;
	...
	public static volatile LinkedList<File> list_cookies_host_system = new LinkedList<File>();
...
//	}
	...
	public static boolean update_cookies_host_system(boolean notify_user_of_empty_cookies)
	{
		try
		{
			...
			try	{list_cookies_host_system.clear();}catch(Exception e){	list_cookies_host_system = new LinkedList<File>();}
			...
			if(driver.isWindows)
			{
				...
				//
				driver.getFileListing(driver.fle_path_app_data_microsoft_cookies, true, null, list_cookies_host_system);
				
				if(list_cookies_host_system == null || list_cookies_host_system.isEmpty())
				{
					
					if(notify_user_of_empty_cookies)
						driver.jop_Error("Punt! No cookies were found at cookie destinations...", false);
				...
				//populate the file
				//
				for(File fle : list_cookies_host_system)
				{
